...
import { updateBookToReturn } from '../../businessLogic/books'
import HttpException from '../../utils/HttpException'

const logger = createLogger('updateBookToReturn')
...
export const handler = middy(async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  logger.debug(`Returning the Book with isbn ${isbn} for lender ${lenderId}.`)
  try {
